...
export default function ConfigModal() {
  ...
  const showAdvancedSettings = config.service !== 'deepl';
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-lg mx-4 p-6 bg-[var(--modal-bg)] rounded-3xl shadow-xl border border-[var(--border-color)]"
        >
